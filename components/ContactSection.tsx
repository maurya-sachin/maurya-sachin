  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        {/* Main Contact Card */}
        <motion.div
          className={`rounded-3xl p-12 text-center backdrop-blur-md border relative overflow-hidden ${
            isDarkMode
            ...
            >
              {contactMethods.map((contact, index) => (
                <motion.a
                  key={contact.label}
                  href={contact.href}
                  className={`p-6 rounded-xl backdrop-blur-sm transition-all duration-300 text-center group border relative overflow-hidden ${
                    isDarkMode
