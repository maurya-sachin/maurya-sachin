      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          >
            ...
            power exceptional web experiences
          </motion.p>
        </motion.div>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {filteredSkills.map((skill, index) => (
              <motion.div
                key={skill.name}
                className={`p-6 rounded-xl border relative overflow-hidden group cursor-pointer ${
                  isDarkMode
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  {/* Progress Bar */}
                  <div
                    className={`h-2 rounded-full overflow-hidden mb-4 ${isDarkMode ? "bg-gray-700" : "bg-gray-200"}`}
                  >
                    <motion.div
