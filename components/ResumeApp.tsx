...
const ResumeApp = () => {
    ...
    const { githubData, loading: githubLoading, error: githubError } = useGitHubData('maurya-sachin')
    ...
    useEffect(() => {
        ...
        const handleScroll = () => {
            const sections = ["hero", "about", "skills", "experience", "projects", "stats", "contact"]
    ...
    return (
        <div
            className={`min-h-screen transition-colors duration-500 ${isDarkMode ? "bg-gray-900 text-white" : "bg-white text-gray-900"
                }`}
            ref={containerRef}
        >
            {/* SEO structured data */}
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        description: "Experienced Frontend Developer specializing in React.js, Next.js, TypeScript with expertise in performance optimization, web accessibility, and modern UI/UX development",
