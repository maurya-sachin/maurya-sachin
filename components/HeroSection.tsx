...
import { ArrowRight, MapPin, Clock, Rocket, Zap, TrendingUp, Calendar, Code } from 'lucide-react'
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                {['React', 'JS', 'TS', 'CSS', '{}', '</>', 'npm', 'git'].map((text, i) => (
                    <motion.div
                        key={text}
            ...
            <motion.div className="max-w-7xl mx-auto relative z-10 w-full" style={{ y: heroY }}>
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    >
                        ...
                        {/* Description */}
                        <motion.div
                            className={`text-lg sm:text-xl lg:text-2xl mb-12 leading-relaxed max-w-2xl ${isDarkMode ? "text-gray-300" : "text-gray-600"
                                }`}
                            initial={{ opacity: 0, y: 30 }}
                            animate={{ opacity: 1, y: 0 }}
                        ...
                        >
                            ...
                            <motion.button
                                ...
                                className={`border-2 text-center px-10 py-4 rounded-xl font-semibold transition-all duration-300 group relative overflow-hidden ${isDarkMode
                            ...
                            >
                                ...
                                />
                                <span className="group-hover:mr-2 transition-all relative z-10">Let's Connect</span>
                    ...
                    >
                        <motion.div
                            className={`rounded-3xl p-8 backdrop-blur-xl border shadow-2xl relative overflow-hidden ${isDarkMode ? "bg-gray-800/50 border-gray-700" : "bg-white/50 border-gray-200"
                                }`}
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    {stats.map((stat, index) => (
                                        ...
                                        >
                                            ...
                                            <div
                                                className={`text-xs opacity-0 group-hover:opacity-100 transition-opacity ${isDarkMode ? "text-gray-400" : "text-gray-500"
                                                    }`}
                                            >
                                                {stat.description}
                                            </div>
