...
import { Award, Users, Briefcase, Zap, Target, Heart, Code, Rocket, Star } from 'lucide-react'
...
const AboutSection: React.FC<AboutSectionProps> = ({ isDarkMode, parallaxY }) => {
    const highlights = [
        {
            icon: Award,
            title: "Performance Expert",
            description: "Consistently achieving 95+ Lighthouse scores and 80% performance improvements through advanced optimization techniques.",
        ...
        },
        {
            ...
            description: "Experienced in cross-functional teams, Agile methodologies, and modern development workflows with strong communication skills.",
        ...
        },
        {
            ...
            description: "Engineering mindset combined with creative solutions for complex frontend challenges and user experience optimization.",
    ...
    const funFacts = [
        ...
        { icon: Zap, text: "80% faster load times achieved", color: "text-yellow-500" },
        { icon: Target, text: "95+ Lighthouse score consistent", color: "text-green-500" },
    ...
    return (
        ...
        >
            ...
            <motion.div className="max-w-6xl mx-auto relative z-10" style={{ y: parallaxY }}>
                {/* Section Header */}
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        with expertise in building scalable, high-performance web applications. My journey combines technical excellence
                        with creative problem-solving to deliver exceptional user experiences that make a difference.
                    </motion.p>
                </motion.div>
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 mb-16">
                    ...
                    <div className="space-y-8">
                        ...
                        <motion.div
                            className={`p-6 rounded-xl border backdrop-blur-sm ${isDarkMode ? "bg-gray-900/50 border-gray-700" : "bg-white/70 border-gray-200"
                                }`}
                            initial={{ opacity: 0, x: 30 }}
                            whileInView={{ opacity: 1, x: 0 }}
                            transition={{ duration: 0.6 }}
                            ...
                            <div className="space-y-4">
                                {funFacts.map((fact, index) => (
                                    ...
                                    >
                                        ...
                                        <span className={`${isDarkMode ? "text-gray-300" : "text-gray-700"} group-hover:text-blue-500 transition-colors`}>
                                            {fact.text}
                                        </span>
                                    </motion.div>
                                ))}
