      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          {mainStats.map((stat, index) => (
            <motion.div
              key={stat.label}
              className={`p-6 rounded-xl border backdrop-blur-sm text-center group relative overflow-hidden ${
                isDarkMode
            ...
            {githubData.repositories
              ...
              .map((repo: unknown, index: number) => (
                <motion.a
                  ...
                  className={`p-6 rounded-xl border backdrop-blur-sm block group relative overflow-hidden ${
                    isDarkMode
                      ? "bg-gray-800/50 border-gray-700 hover:border-gray-600"
                      : "bg-white/50 border-gray-200 hover:border-gray-300"
                  }`}
        ...
        >
          <motion.div
            className={`inline-flex items-center px-6 py-3 rounded-xl border backdrop-blur-sm ${
              isDarkMode
